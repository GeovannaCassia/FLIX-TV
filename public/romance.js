fetch('https://api.themoviedb.org/3/discover/tv?api_key=7644214527bf3eb5a617a3505fd2f90a&with_genres=18')
  .then(res => res.json())
  .then(data => {
    ...
    for (let i = 0; i < data.results.length; i++) {
      ...
      if (series.overview && series.overview.trim() !== "") {
        ...
        document.getElementById('SeriesRomance').innerHTML = strN;
      }
    }
    for (let i = 0; i < data.results.length; i++) {
